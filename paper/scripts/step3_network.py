...
def figure3_network():
    ...
    lu = [
        ...
        ('OptLoad-LU', [158, 156, 154]),
        ('OptLoad-D',  [170, 168, 166]),
        ('Insertion',  [210, 208, 205]),
        ('LIFO',       [122, 120, 118]),
        ('FoodMatch',  [218, 215, 212]),
    ]
    distance = [
        ('OptLoad-S',  [61200, 91000, 125000]),
        ('OptLoad-LU', [59000, 88000, 121000]),
        ('OptLoad-D',  [54000, 80000, 112000]),
        ('Insertion',  [56500, 84000, 115500]),
        ('LIFO',       [55500, 82500, 113500]),
        ('FoodMatch',  [57500, 84500, 117000]),
    ]
